...
var EmailFormatChecker = function EmailFormatChecker(e) {
  var idCheck = document.querySelector(".sign-up__input__check--id-isEqual");
  var value = e.value;
...
var isPasswordEqual = false; // 비밀번호 확인 핸들러

var passwordChecker = function passwordChecker(e) {
  var passwordInput = document.querySelector(".sign-up__input--pw");
  var passwordRepeat = document.querySelector(".sign-up__input--pw-repeat");
  var passwordCheck = document.querySelector(".sign-up__input__check--pw-isEqual");
  var password = passwordInput.value;
  var passwordCheckValue = passwordRepeat.value;
...
var major = document.querySelector(".sign-up__input--major");

var handleOnInput = function handleOnInput(el) {
...
var autoHypen = function autoHypen(e) {
  var phoneNumber = document.querySelector(".sign-up__input--phone-number");
  var phoneNumberCheck = document.querySelector(".sign-up__input__check--phone-number-is-valid-format"); // 숫자만 입력하게 해줌 (정규식)

  var value = e.value.replace(/\D+/g, "");
  var maxLength = 11;
  var result = ""; // 입력한 숫자 11자리(전화번호)로 루핑
  ...
  if (phoneNumber.value.length == 13) {
    phoneNumberCheck.innerHTML = "<strong style='color : blue'>좋아요!</strong>";
  } else {
...
var registerBtn = document.querySelector(".sign-up__input__btn--register");
...
var cancelBtn = document.querySelector(".sign-up__input__btn--cancel");
...
//# sourceMappingURL=/BCSD.e31bb0bc.js.map